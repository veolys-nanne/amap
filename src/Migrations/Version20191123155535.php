 ...
 */
final class Version20191123155535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE amap_credit (id INT AUTO_INCREMENT NOT NULL, producer_id INT DEFAULT NULL, member_id INT DEFAULT NULL, date DATE NOT NULL, total_amount NUMERIC(10, 2) NOT NULL, current_amount NUMERIC(10, 2) NOT NULL, object VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, active TINYINT(1) NOT NULL, deleted TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_411225A089B658FE (producer_id), INDEX IDX_411225A07597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf('mysql' !== $this->connection->getDatabasePlatform()->getName(), 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE amap_document (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, role VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, text LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, deleted TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf('mysql' !== $this->connection->getDatabasePlatform()->getName(), 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE amap_planning_element_user (planning_element_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_7C22031A76ED395 (user_id), INDEX IDX_7C2203186BE2B44 (planning_element_id), PRIMARY KEY(planning_element_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf('mysql' !== $this->connection->getDatabasePlatform()->getName(), 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE amap_product (id INT AUTO_INCREMENT NOT NULL, producer_id INT DEFAULT NULL, portfolio_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, product_order INT DEFAULT NULL, price NUMERIC(10, 2) NOT NULL, active TINYINT(1) NOT NULL, deleted TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_5FC4AB15B96B5643 (portfolio_id), INDEX IDX_5FC4AB1589B658FE (producer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf('mysql' !== $this->connection->getDatabasePlatform()->getName(), 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE amap_thumbnail (id INT AUTO_INCREMENT NOT NULL, portfolio_id INT DEFAULT NULL, media VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, description LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, updated_at DATETIME DEFAULT NULL, INDEX IDX_A92230A1B96B5643 (portfolio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf('mysql' !== $this->connection->getDatabasePlatform()->getName(), 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('CREATE TABLE amap_user (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, portfolio_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, broadcast_list LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\', user_order INT DEFAULT NULL, color VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, firstname VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, lastname VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, address VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, city VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, zip_code INT DEFAULT NULL, password VARCHAR(64) NOT NULL COLLATE utf8mb4_unicode_ci, active TINYINT(1) NOT NULL, roles LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\', deleveries LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\', phone_numbers LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\', deleted TINYINT(1) DEFAULT \'0\' NOT NULL, denomination VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, payto VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, new TINYINT(1) NOT NULL, reset_password VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, UNIQUE INDEX UNIQ_D6882FFCB96B5643 (portfolio_id), UNIQUE INDEX UNIQ_D6882FFCE7927C74 (email), INDEX IDX_D6882FFC727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
    }
